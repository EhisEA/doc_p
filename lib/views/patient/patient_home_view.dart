...
class PatientHomeView extends StatelessWidget {
  PatientHomeView({Key key}) : super(key: key);

  final Random random = Random();
  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<PatientHomeViewModel>.reactive(
      viewModelBuilder: () => locator<PatientHomeViewModel>(),
